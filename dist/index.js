...
app.post('/signin', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const user = yield (0, db_1.getUserByEmailPassword)(email, password);
        if (!user) {
            next("User not found");
            return;
        }
...
}), jwt_1.setJwtTokenInCookieMiddleware);
app.post('/signup', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const user = yield (0, db_1.createUserByEmailPassword)(email, password);
        if (!user) {
            next("User not found");
            return;
        }
...
app.get('/users', (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield (0, db_1.listUsers)();
    res.send(users);
}));
app.listen(port, () => {
